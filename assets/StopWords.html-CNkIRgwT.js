import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as e,o as l}from"./app-BRBKyLnU.js";const i={};function p(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="全局敏感词处理" tabindex="-1"><a class="header-anchor" href="#全局敏感词处理"><span>全局敏感词处理</span></a></h1><p>基于ToolGood.Words类库，配合敏感字的文本文件，写的API接口。</p><ul><li><a href="https://github.com/luoyunchong/dotnetcore-examples/tree/master/aspnetcore-stopwords" target="_blank" rel="noopener noreferrer">https://github.com/luoyunchong/dotnetcore-examples/tree/master/aspnetcore-stopwords</a></li></ul><p>一共二种方式</p><h2 id="_1-toolgood-words" tabindex="-1"><a class="header-anchor" href="#_1-toolgood-words"><span>1.ToolGood.Words</span></a></h2><p>类库配合敏感库</p><ul><li><a href="https://github.com/toolgood/ToolGood.Words" target="_blank" rel="noopener noreferrer">ToolGood.Words</a></li></ul><p>简单用法</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[Fact]</span></span>
