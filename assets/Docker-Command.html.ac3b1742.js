import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{o as p,c,a as n,b as r,F as o,e as s,d as l,r as t}from"./app.117ba083.js";const i={},m=n("h1",{id:"docker-\u547D\u4EE4\u884C",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-\u547D\u4EE4\u884C","aria-hidden":"true"},"#"),s(" Docker \u547D\u4EE4\u884C")],-1),k=s("Command-Line Interfaces "),b={href:"https://docs.docker.com/engine/reference/run/",title:"https://docs.docker.com/engine/reference/run/",target:"_blank",rel:"noopener noreferrer"},u=s("https://docs.docker.com/engine/reference/run/"),d=l(`<div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> images  <span class="token comment"># \u67E5\u770B\u6240\u6709\u955C\u50CF</span>

<span class="token function">docker</span> <span class="token function">ps</span> <span class="token parameter variable">-a</span> <span class="token comment">#\u663E\u793A\u6240\u6709\u7684\u5BB9\u5668\uFF0C\u5305\u62EC\u672A\u8FD0\u884C\u7684\u3002</span>
<span class="token function">docker</span> <span class="token function">ps</span> <span class="token parameter variable">-l</span> <span class="token comment">#\u6700\u540E\u542F\u52A8\u7684\u5BB9\u5668</span>

<span class="token function">docker</span> <span class="token function">rm</span> \u5BB9\u5668id   <span class="token comment">#\u5220\u9664\u5BB9\u5668</span>
<span class="token function">docker</span> <span class="token function">rm</span> <span class="token variable"><span class="token variable">$(</span><span class="token function">docker</span> <span class="token function">ps</span> <span class="token parameter variable">-q</span> <span class="token parameter variable">-a</span><span class="token variable">)</span></span> <span class="token comment">#\u4E00\u6B21\u6027\u5220\u9664\u6240\u6709\u7684\u5BB9\u5668</span>

<span class="token function">docker</span> rmi \u955C\u50CFid/\u955C\u50CF\u540D\u79F0  <span class="token comment">#\u5220\u9664\u955C\u50CF</span>
<span class="token function">docker</span> rmi <span class="token variable"><span class="token variable">$(</span><span class="token function">docker</span> images <span class="token parameter variable">-q</span><span class="token variable">)</span></span> <span class="token comment">#\u4E00\u6B21\u6027\u5220\u9664\u6240\u6709\u7684\u955C\u50CF\u3002</span>

<span class="token function">docker</span> build <span class="token parameter variable">-t</span> igeekfan/demo <span class="token builtin class-name">.</span>  <span class="token comment">#\u8FD0\u884C\u6784\u5EFA\u547D\u4EE4,\u6784\u5EFADocker \u955C\u50CF\u3002 </span>

<span class="token function">docker</span> run \u955C\u50CF <span class="token comment">#\u8FD0\u884C</span>
<span class="token function">docker</span> run <span class="token parameter variable">-it</span> <span class="token parameter variable">-p</span> <span class="token number">5000</span>:80 igeekfan/demo
<span class="token comment">#5000\u662F\u8FD0\u884C\u540E\uFF0Cdocker\u5BF9\u5916\u7684\u7AEF\u53E3\uFF0C80\u662F\u8FD9\u4E2A\u670D\u52A1\u5BF9\u5916\u7684\u7AEF\u53E3\uFF0C\u5176\u4E2DDockerfile \u5B58\u5728\u8BED\u53E5EXPOSE 80</span>
<span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token number">5000</span>:80 igeekfan/demo 
<span class="token parameter variable">-d</span> \u53C2\u6570\u540E\u53F0\u8FD0\u884C
...
<span class="token function">sudo</span> <span class="token function">apt</span> remove <span class="token parameter variable">--purge</span> docker.io
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div>`,7);function f(v,g){const a=t("ExternalLinkIcon");return p(),c(o,null,[m,n("ul",null,[n("li",null,[k,n("a",b,[u,r(a)])])]),d],64)}var x=e(i,[["render",f],["__file","Docker-Command.html.vue"]]);export{x as default};
