...
<span class="token keyword">else</span>
    ...
    <span class="token function">docker</span> <span class="token function">rm</span> lincms-web-1 <span class="token parameter variable">-f</span>
...
<span class="token keyword">else</span>
    ...
    <span class="token function">docker</span> rmi <span class="token parameter variable">--force</span> registry.cn-hangzhou.aliyuncs.com/igeekfan/lincms-web
<span class="token keyword">fi</span>
...
<span class="token function">docker</span> run <span class="token parameter variable">--restart</span> unless-stopped <span class="token parameter variable">-p</span> <span class="token number">5011</span>:80 <span class="token parameter variable">--name</span> lincms-web-1 <span class="token parameter variable">-d</span> registry.cn-hangzhou.aliyuncs.com/igeekfan/lincms-web

<span class="token function">docker</span> <span class="token function">rm</span> lincms-web-2 <span class="token parameter variable">-f</span>
<span class="token function">docker</span> <span class="token function">rm</span> lincms-web-3 <span class="token parameter variable">-f</span>
<span class="token function">docker</span> <span class="token function">rm</span> lincms-web-4 <span class="token parameter variable">-f</span>

<span class="token function">docker</span> run <span class="token parameter variable">--restart</span> unless-stopped <span class="token parameter variable">-p</span> <span class="token number">5012</span>:80 <span class="token parameter variable">--name</span> lincms-web-2 <span class="token parameter variable">-d</span> registry.cn-hangzhou.aliyuncs.com/igeekfan/lincms-web
<span class="token function">docker</span> run <span class="token parameter variable">--restart</span> unless-stopped <span class="token parameter variable">-p</span> <span class="token number">5020</span>:80 <span class="token parameter variable">--name</span> lincms-web-3 <span class="token parameter variable">-d</span> registry.cn-hangzhou.aliyuncs.com/igeekfan/lincms-web
<span class="token function">docker</span> run <span class="token parameter variable">--restart</span> unless-stopped <span class="token parameter variable">-p</span> <span class="token number">5021</span>:80 <span class="token parameter variable">--name</span> lincms-web-4 <span class="token parameter variable">-d</span> registry.cn-hangzhou.aliyuncs.com/igeekfan/lincms-web
...
dotnet nuget push IGeekFan.AspNetCore.Knife4jUI.0.0.11.nupkg --api-key Your-API-Key <span class="token parameter variable">--source</span> https://api.nuget.org/v3/index.json
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div>`,7);function p(r,t){return e}var c=n(a,[["render",p],["__file","Docker-CMS.html.vue"]]);export{c as default};
